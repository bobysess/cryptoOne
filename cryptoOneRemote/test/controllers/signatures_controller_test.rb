...
class SignaturesControllerTest < ActionController::TestCase
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post :create, signature: { encrypted_public_key: @signature.encrypted_public_key, signature: @signature.signature, signature_date: @signature.signature_date, signority_id: @signature.signority_id, user_id: @signature.user_id }
    end
  ...
  test "should update signature" do
    patch :update, id: @signature, signature: { encrypted_public_key: @signature.encrypted_public_key, signature: @signature.signature, signature_date: @signature.signature_date, signority_id: @signature.signority_id, user_id: @signature.user_id }
    assert_redirected_to signature_path(assigns(:signature))
  end
